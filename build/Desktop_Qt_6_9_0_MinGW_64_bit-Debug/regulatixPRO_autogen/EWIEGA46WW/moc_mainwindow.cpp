...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'addSeriesFromFrame'
        QtMocHelpers::SlotData<void(const SimulationFrame &)>(32, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 33, 34 },
        }}),
    };
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 28: _t->addSeriesFromFrame((*reinterpret_cast< std::add_pointer_t<SimulationFrame>>(_a[1]))); break;
        default: ;
        }
    }
}
