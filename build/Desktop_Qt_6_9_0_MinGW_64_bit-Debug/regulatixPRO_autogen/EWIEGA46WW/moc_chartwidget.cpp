...
template <> constexpr inline auto ChartWidget::qt_create_metaobjectdata<qt_meta_tag_ZN11ChartWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'initialize_chart'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'get_series_list'
        QtMocHelpers::SlotData<std::vector<QLineSeries*>() const>(10, 2, QMC::AccessPublic, 0x80000000 | 11),
        // Slot 'get_position'
        QtMocHelpers::SlotData<ChartPosition() const>(12, 2, QMC::AccessPublic, 0x80000000 | 5),
    };
...
void ChartWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->initialize_chart(); break;
        case 4: { std::vector<QLineSeries*> _r = _t->get_series_list();
            if (_a[0]) *reinterpret_cast< std::vector<QLineSeries*>*>(_a[0]) = std::move(_r); }  break;
        case 5: { ChartPosition _r = _t->get_position();
