...
public:
    ...
    QPushButton *Network;
    QPushButton *chackNetwork;
    QLabel *labelChacConnected;
    QGroupBox *groupBox;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        formLayout_5->setWidget(0, QFormLayout::ItemRole::LabelRole, simulation_start_button);
        ...
        formLayout_5->setWidget(0, QFormLayout::ItemRole::FieldRole, simulation_stop_button);
        ...
        formLayout_5->setWidget(1, QFormLayout::ItemRole::SpanningRole, simulation_reset_button);

        label_10 = new QLabel(groupBox_4);
        label_10->setObjectName("label_10");

        formLayout_5->setWidget(2, QFormLayout::ItemRole::LabelRole, label_10);

        simulation_duration_input = new QDoubleSpinBox(groupBox_4);
        simulation_duration_input->setObjectName("simulation_duration_input");

        formLayout_5->setWidget(2, QFormLayout::ItemRole::FieldRole, simulation_duration_input);

        label_14 = new QLabel(groupBox_4);
        label_14->setObjectName("label_14");

        formLayout_5->setWidget(3, QFormLayout::ItemRole::LabelRole, label_14);
        ...
        formLayout_5->setWidget(3, QFormLayout::ItemRole::FieldRole, simulation_interval_input);

        labelConnected = new QLabel(groupBox_4);
        labelConnected->setObjectName("labelConnected");

        formLayout_5->setWidget(4, QFormLayout::ItemRole::LabelRole, labelConnected);

        Network = new QPushButton(groupBox_4);
        Network->setObjectName("Network");

        formLayout_5->setWidget(4, QFormLayout::ItemRole::FieldRole, Network);

        chackNetwork = new QPushButton(groupBox_4);
        chackNetwork->setObjectName("chackNetwork");

        formLayout_5->setWidget(5, QFormLayout::ItemRole::FieldRole, chackNetwork);

        labelChacConnected = new QLabel(groupBox_4);
        labelChacConnected->setObjectName("labelChacConnected");

        formLayout_5->setWidget(5, QFormLayout::ItemRole::LabelRole, labelChacConnected);
        ...
        formLayout_2->setWidget(0, QFormLayout::ItemRole::FieldRole, arx_a_input);
        ...
        formLayout_2->setWidget(1, QFormLayout::ItemRole::FieldRole, arx_b_input);

        label_4 = new QLabel(groupBox);
        label_4->setObjectName("label_4");

        formLayout_2->setWidget(2, QFormLayout::ItemRole::LabelRole, label_4);

        arx_delay_input = new QSpinBox(groupBox);
        arx_delay_input->setObjectName("arx_delay_input");
        arx_delay_input->setMinimum(1);

        formLayout_2->setWidget(2, QFormLayout::ItemRole::FieldRole, arx_delay_input);

        label_5 = new QLabel(groupBox);
        label_5->setObjectName("label_5");

        formLayout_2->setWidget(3, QFormLayout::ItemRole::LabelRole, label_5);
        ...
        formLayout_2->setWidget(3, QFormLayout::ItemRole::FieldRole, arx_noisetype_input);

        label_6 = new QLabel(groupBox);
        label_6->setObjectName("label_6");

        formLayout_2->setWidget(4, QFormLayout::ItemRole::LabelRole, label_6);
        ...
        formLayout_2->setWidget(4, QFormLayout::ItemRole::FieldRole, arx_noise_input);
        ...
        outside_sum_radio = new QRadioButton(groupBox_2);
        ...
        inside_sum_radio = new QRadioButton(groupBox_2);
        ...
        formLayout_3->setLayout(0, QFormLayout::ItemRole::FieldRole, horizontalLayout_4);
        ...
        formLayout_3->setWidget(1, QFormLayout::ItemRole::FieldRole, pid_ti_input);
        ...
        formLayout_3->setWidget(3, QFormLayout::ItemRole::FieldRole, pid_td_input);

        label_9 = new QLabel(groupBox_2);
        label_9->setObjectName("label_9");

        formLayout_3->setWidget(5, QFormLayout::ItemRole::LabelRole, label_9);

        pid_kp_input = new QDoubleSpinBox(groupBox_2);
        pid_kp_input->setObjectName("pid_kp_input");

        formLayout_3->setWidget(5, QFormLayout::ItemRole::FieldRole, pid_kp_input);
        ...
        formLayout_4->setWidget(0, QFormLayout::ItemRole::FieldRole, generator_amplitude_input);
        ...
        formLayout_4->setWidget(1, QFormLayout::ItemRole::FieldRole, generator_frequency_input);

        label_13 = new QLabel(groupBox_3);
        label_13->setObjectName("label_13");

        formLayout_4->setWidget(2, QFormLayout::ItemRole::LabelRole, label_13);
        ...
        formLayout_4->setWidget(2, QFormLayout::ItemRole::FieldRole, generator_infill_input);

        label_12 = new QLabel(groupBox_3);
        label_12->setObjectName("label_12");

        formLayout_4->setWidget(3, QFormLayout::ItemRole::LabelRole, label_12);
        ...
        formLayout_4->setWidget(3, QFormLayout::ItemRole::FieldRole, generator_generatortype_input);

        verticalSpacer_3 = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        formLayout_4->setItem(5, QFormLayout::ItemRole::LabelRole, verticalSpacer_3);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelConnected->setText(QCoreApplication::translate("MainWindow", "Not Connected", nullptr));
        Network->setText(QCoreApplication::translate("MainWindow", "Network", nullptr));
        chackNetwork->setText(QCoreApplication::translate("MainWindow", "Chack Network", nullptr));
        labelChacConnected->setText(QCoreApplication::translate("MainWindow", "Not Connected", nullptr));
