...
#include "../../../../../../SK_regulator_PID(1)/exportdialog.h"
...
static constexpr auto qt_meta_stringdata_ZN12ExportDialogE = QtMocHelpers::stringData(
    "ExportDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ExportDialogE[] = {
...
Q_CONSTINIT const QMetaObject ExportDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ExportDialogE.offsetsAndSizes,
    qt_meta_data_ZN12ExportDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ExportDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *ExportDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ExportDialogE.stringdata0))
